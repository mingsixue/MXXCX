...
Component({
    properties: {
        ...
        maxLength: {
            ...
            observer(e) {
                let t = e;
                (e < 0 && (t = 999), this.setData({ limit: t }));
            },
        },
        showLimit: { type: Boolean, value: !0 },
        autoFocus: { type: Boolean, value: !1 },
        autoHeight: { type: Boolean, value: !1 },
        height: { type: Number, value: 120 },
        ...
        adjustKeyboardTo: { type: String, value: "cursor" },
    ...
    ready() {
        this.data.limit || this.setData({ limit: 140 });
    },
    methods: {
        inputChange(e) {
            let t = e.detail.value;
            (this.setData({ value: t, len: String(t).length }),
