    ...
    methods: {
        ...
        _sync() {
            const { loading: e, animate: t, rows: s } = this.data,
                ...
                a = [];
            for (let e = 0; e < l; e++) a.push({ index: e, last: e === l - 1 && l > 1 });
